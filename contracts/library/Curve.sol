...
library CurveBabyJubJub {
    ...
    uint256 public constant GeneratorX =
        0x23343E3445B673D38BCBA38F25645ADB494B1255B1162BB40F41A59F4D4B45E;
    uint256 public constant GeneratorY =
    ...
    function pointSub(
        ...
        uint256 invX = submod(0, _x2, Q);
        return pointAdd(_x1, _y1, invX, _y2);
    }
    ...
    function privateToPublic(
        ...
        return pointMul(GeneratorX, GeneratorY, privateKey);
    }
